				...
				<tr>
					...
					<td>
						...
						foreach(get_option('mdocs-displayed-file-info') as $key => $option) {
							...
							<input type="hidden" name="mdocs-displayed-file-info[<?php echo $key; ?>][color]" value="<?php echo $option['color']; ?>" />
							<input type="hidden" name="mdocs-displayed-file-info[<?php echo $key; ?>][function]" value="<?php echo $option['function']; ?>" />
							<input type="checkbox" name="mdocs-displayed-file-info[<?php echo $key; ?>][show_in_post]" value="1"  <?php echo $checked; ?>/> <?php echo __('Show','memphis-documents-library').' '.$option['text']; ?><br>
							<?php
