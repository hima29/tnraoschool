...
class SCP_Video_Popup extends WPBakeryShortCode {
	...
	public function integrateWithVC() {
		...
		vc_map( array(
			'name'        => esc_html__( 'Video Popup', 'superwise-plugin' ),
			'description' => '',
			...
			'params'      => array(
				...
				array(
					'type'        => 'textfield',
					'class'       => '',
					'heading'     => esc_html__( 'Video Url', 'superwise-plugin' ),
					'param_name'  => 'video_url',
					'value'       => '',
					'description' => esc_html__( 'Add Youtube/Vimeo video url', 'superwise-plugin' ),
				),
				array(
					'type'        => 'textfield',
					'class'       => '',
					'heading'     => esc_html__( 'Video Width', 'superwise-plugin' ),
				...
				array(
					'type'        => 'textfield',
					'class'       => '',
					'heading'     => esc_html__( 'Video Height', 'superwise-plugin' ),
				...
				array(
					'type'       => 'colorpicker',
					'heading'    => esc_html__( 'Play Badge Color', 'superwise-plugin' ),
					'param_name' => 'play_badge_color',
					'value'      => '#fff',
				),
				array(
					'type'        => 'attach_image',
					'heading'     => esc_html__( 'Thumbnail', 'superwise-plugin' ),
					'param_name'  => 'image',
					'value'       => '',
					'description' => esc_html__( 'Select image from media library.', 'superwise-plugin' ),
					'dependency'  => array(
						'value' => 'media_library',
					),
				),
...
//			$a_attrs['target'] = $img_link_target;
			...
			$html = '<a ' . vc_stringify_attributes( $a_attrs ) . ' class="' . esc_attr( $wrapperClass ) . '">' . $img['thumbnail'] . $play_icon . '</a>';
		} else {
