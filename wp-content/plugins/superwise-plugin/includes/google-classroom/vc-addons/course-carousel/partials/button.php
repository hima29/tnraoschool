<div class="links">
	...
	<a class="course-link-btn" href="<?php echo get_permalink( $post_id ); ?>" title="<?php echo esc_attr( $post_title ); ?>"><?php esc_html_e( 'See details', 'superwise-plugin' ); ?></a>


	<?php if ( is_a( $course, 'Aislin_Classroom_Course' ) ): ?>
		
		<a class="classroom-link" href="<?php echo esc_url( $course->get_link() ); ?>" title="<?php echo esc_attr( $post_title ); ?>" target="_blank">
