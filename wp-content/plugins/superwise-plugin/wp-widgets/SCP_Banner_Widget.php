...
class SCP_Banner_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_ops = array(
			...
			'description' => esc_html__( 'Banner', 'superwise-plugin' ),
		);
	...
	public function form( $instance ) {
		...
		$default = array(
			'title'       => esc_html__( 'Banner', 'superwise-plugin' ),
			'label'       => '',
			'text'        => 'Banner text',
			'button_text' => '',
			'button_link' => '',
		...
		<p>
			<label
				for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title', 'superwise-plugin' ); ?></label><br/>
		...
		<p>
			<label
				for="<?php echo esc_attr( $this->get_field_id( 'label' ) ); ?>"><?php esc_html_e( 'Label', 'superwise-plugin' ); ?></label><br/>
		...
		<p>
			<label
				for="<?php echo esc_attr( $this->get_field_id( 'button_text' ) ); ?>"><?php esc_html_e( 'Button Text', 'superwise-plugin' ); ?></label><br/>
		...
		<p>
			<label
				for="<?php echo esc_attr( $this->get_field_id( 'button_link' ) ); ?>"><?php esc_html_e( 'Button Link', 'superwise-plugin' ); ?></label><br/>
