				...
				public function theme_setup_wizard_content( $content ) {
					if ( $this->is_possible_upgrade() ) {
						array_unshift_assoc( $content, 'upgrade', array(
							'title'            => __( 'Upgrade', 'superwise' ),
							'description'      => __( 'Upgrade Content and Settings', 'superwise' ),
							'pending'          => __( 'Pending.', 'superwise' ),
							'installing'       => __( 'Installing Updates.', 'superwise' ),
							'success'          => __( 'Success.', 'superwise' ),
